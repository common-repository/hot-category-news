 ...
 * Plugin URI: https://hot-themes.com/wordpress/plugins/category-news
...
class CategoryNews extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'hot-category-news', __('Hot Category News', 'hot_category_news'), $widget_ops, $control_ops );
	...
	function widget( $args, $instance ) {
		...
		//-------------------------RENDER START----------------------------------------------?>
		<div class="hot-category-news <?php echo $instance['layout']; ?>">
			<?php
				$post_slots = array();
				$args = array();
				...
				///-- POST RENDER START------------ 
					...
					// Post thumbnail
					if ($instance['featuredimages']) {
						if(get_the_post_thumbnail()) {
							$html .= '<a href="'.get_permalink(get_the_ID()).'">';
							$html .= get_the_post_thumbnail(get_the_ID(), $instance['featuredimagesize']);
							$html .= '</a>';
						}
					}
				...
				if( $instance['separators'] && $instance['separator_on_last'] ) {
					echo '<div class="post_separator"></div>';
				}
...
<div class="clr"></div>
	...
	function form( $instance ) {
		...
		<input type="number" name="<?php echo $this->get_field_name( 'count' ); ?>" id="<?php echo $this->get_field_id( 'count' ); ?>" value="<?php echo $instance['count']; ?>" class="numeric" /></p>

		<p><?php _e('Layout','hot_category_news'); ?><br/>
		<select class="select" id="<?php echo $this->get_field_id( 'layout' ); ?>" name="<?php echo $this->get_field_name( 'layout' ); ?>" >
									
			<option value="vertical">
			<?php _e('Vertical', 'hot_category_news'); ?>
			</option>
		
			<option value="horizontal">
			<?php _e('Horizontal', 'hot_category_news'); ?>
			</option>
									
		</select></p>
		<script>
			document.getElementById('<?php echo $this->get_field_id( 'layout' ); ?>').value = "<?php echo $instance['layout']; ?>";
		</script>
		...
		<p><?php _e('Show featured image','hot_category_news'); ?><br/>
		<select class="select" id="<?php echo $this->get_field_id( 'featuredimages' ); ?>" name="<?php echo $this->get_field_name( 'featuredimages' ); ?>" >
		...
		<script>
			document.getElementById('<?php echo $this->get_field_id( 'featuredimages' ); ?>').value = "<?php echo $instance['featuredimages']; ?>";
		</script>

		<p><?php _e('Featured image size','hot_category_news'); ?><br/>
		<select class="select" id="<?php echo $this->get_field_id( 'featuredimagesize' ); ?>" name="<?php echo $this->get_field_name( 'featuredimagesize' ); ?>" >

		    <option value="thumbnail">
			<?php _e('Thumbnail', 'hot_category_news'); ?>
			</option>
			
			<option value="medium">
			<?php _e('Medium', 'hot_category_news'); ?>
			</option>

			<option value="large">
			<?php _e('Large', 'hot_category_news'); ?>
			</option>

			<option value="full">
			<?php _e('Full', 'hot_category_news'); ?>
			</option>

		</select></p>
		<script>
			document.getElementById('<?php echo $this->get_field_id( 'featuredimagesize' ); ?>').value = "<?php echo $instance['featuredimagesize']; ?>";
		</script>
		...
		<p><?php _e('Show separators','hot_category_news'); ?><br/>
		<select class="select" id="<?php echo $this->get_field_id( 'separators' ); ?>" name="<?php echo $this->get_field_name( 'separators' ); ?>" >
		...
		<script>
			document.getElementById('<?php echo $this->get_field_id( 'separators' ); ?>').value = "<?php echo $instance['separators']; ?>";
		</script>	
